...
(defrule list () (list 'a))
(defrule var (x) x)
(defrule atom-quoted-symbol () 'a)
(defrule atom-character () #\a)
(defrule atom-string () "abc")
(defrule atom-vector () #(1 2 3))
(defrule atom-number () 5)
(defrule atom-anychar () char)
(defrule atom-anybyte () byte)
(defrule atom-anysymbol () symbol)
(defrule atom-anyform () form)
(defrule atom-anylist () list)
(defrule atom-anyvector () vector)
(defrule atom-anynumber () number)
(defrule atom-anystring () string)
...
(define-test atom-test ()
  (check
    (test-parseq 'atom-quoted-symbol '(a) t 'a)
    (test-parseq 'atom-quoted-symbol '(b) nil nil)
    (test-parseq 'atom-character '(#\a) t #\a)
    (test-parseq 'atom-character '(#\b) nil nil)
    (test-parseq 'atom-string "abc" t "abc")
    (test-parseq 'atom-string "def" nil nil)
    (test-parseq 'atom-vector #(1 2 3) t #(1 2 3) nil #'equalp)
    (test-parseq 'atom-vector #(4 5 6) nil nil #'equalp)
    (test-parseq 'atom-number '(5) t 5)
    (test-parseq 'atom-number '(4) nil nil)
    (test-parseq 'atom-anychar '(#\f) t #\f)
    (test-parseq 'atom-anychar '(#\g) t #\g)
    (test-parseq 'atom-anychar '(f) nil nil)
    (test-parseq 'atom-anybyte '(255) t 255)
    (test-parseq 'atom-anybyte '(256) nil nil)
    (test-parseq 'atom-anybyte '(0) t 0)
    (test-parseq 'atom-anybyte '(-1) nil nil)
    (test-parseq 'atom-anysymbol '(f) t 'f)
    (test-parseq 'atom-anysymbol '(#\f) nil nil)
    (test-parseq 'atom-anyform '(nil) t nil)
    (test-parseq 'atom-anyform '(#\a) t #\a)
    (test-parseq 'atom-anyform '((foo)) t '(foo))
    (test-parseq 'atom-anylist '(nil) t nil)
    (test-parseq 'atom-anylist '((+ 1 2)) t '(+ 1 2))
    (test-parseq 'atom-anylist '(4) nil nil)
    (test-parseq 'atom-anyvector '(#(1 2)) t #(1 2) nil #'equalp)
    (test-parseq 'atom-anyvector '(4) nil nil nil #'equalp)
    (test-parseq 'atom-anynumber '(4) t 4)
    (test-parseq 'atom-anynumber '(#\4) nil nil)
    (test-parseq 'atom-anystring '("foo") t "foo")
    (test-parseq 'atom-anystring '(#\f) nil nil)))
