...
(parseq:defrule terminal-char-expr-not () (char "^+a-zA-D7-9^.;-"))
(parseq:defrule terminal-type-int () (type integer))
(parseq:defrule terminal-type-multi () (type integer float))
...
(define-test terminal-test ()
  (check
    ...
    ;; (char "^+a-zA-D7-9.;-")
    (test-parseq 'terminal-char-expr-not "a" nil nil)
    (test-parseq 'terminal-char-expr-not "z" nil nil)
    (test-parseq 'terminal-char-expr-not "7" nil nil)
    (test-parseq 'terminal-char-expr-not "8" nil nil)
    (test-parseq 'terminal-char-expr-not "9" nil nil)
    (test-parseq 'terminal-char-expr-not "." nil nil)
    (test-parseq 'terminal-char-expr-not ";" nil nil)
    (test-parseq 'terminal-char-expr-not "-" nil nil)
    (test-parseq 'terminal-char-expr-not "^" nil nil)
    (test-parseq 'terminal-char-expr-not "3" t #\3)
    (test-parseq 'terminal-char-expr-not "(" t #\()
    (test-parseq 'terminal-char-expr-not "," t #\,)
    ;; (type integer)
    (test-parseq 'terminal-type-int '(3) t 3)
    (test-parseq 'terminal-type-int '(-5) t -5)
    (test-parseq 'terminal-type-int '(2.3) nil nil)
    (test-parseq 'terminal-type-int '(a) nil nil)
    (test-parseq 'terminal-type-int '(#\a) nil nil)
    ;; (type integer float)
    (test-parseq 'terminal-type-multi '(3) t 3)
    (test-parseq 'terminal-type-multi '(-5) t -5)
    (test-parseq 'terminal-type-multi '(2.3) t 2.3)
    (test-parseq 'terminal-type-multi '(a) nil nil)
    (test-parseq 'terminal-type-multi '(#\a) nil nil)))
...
(parseq:defrule peg-expr-and~~-backtrack () (or (and~~ (3 3) 'a 'b) (and~~ (2 2) 'a 'b)))

(define-test and~-test ()
  (check
    ;; (and~ 'a 'b 'c 'd)
    (test-parseq 'peg-expr-and~ (shuffle '(a b c d)) t '(a b c d))
    (test-parseq 'peg-expr-and~ (shuffle '(a b c d)) t '(a b c d))
    (test-parseq 'peg-expr-and~ (shuffle '(a b c d)) t '(a b c d))
    (test-parseq 'peg-expr-and~ (shuffle '(a b c d)) t '(a b c d))
    (test-parseq 'peg-expr-and~ (shuffle '(a b c d)) t '(a b c d))
    ...
    (test-parseq 'peg-expr-and~ (shuffle '(a b c)) nil nil)
    (test-parseq 'peg-expr-and~ (shuffle '(a b c)) nil nil)
    (test-parseq 'peg-expr-and~ (shuffle '(a b c)) nil nil)
    (test-parseq 'peg-expr-and~ (shuffle '(a b c)) nil nil)
    (test-parseq 'peg-expr-and~ (shuffle '(a b c)) nil nil)
    ...
    (test-parseq 'peg-expr-and~ '(a b c d a) nil nil)
    ...
    (test-parseq 'peg-expr-and~~ (shuffle '(a b b d d)) t '((a) (b b) () (d d)))
    (test-parseq 'peg-expr-and~~ (shuffle '(a b b d d)) t '((a) (b b) () (d d)))
    (test-parseq 'peg-expr-and~~ (shuffle '(a b b d d)) t '((a) (b b) () (d d)))
    (test-parseq 'peg-expr-and~~ (shuffle '(a b b d d)) t '((a) (b b) () (d d)))
    (test-parseq 'peg-expr-and~~ (shuffle '(a b b d d)) t '((a) (b b) () (d d)))
    ...
    (test-parseq 'peg-expr-and~~ (shuffle '(a a b b c d d)) nil nil)
    (test-parseq 'peg-expr-and~~ (shuffle '(a a b b c d d)) nil nil)
    (test-parseq 'peg-expr-and~~ (shuffle '(a a b b c d d)) nil nil)
    (test-parseq 'peg-expr-and~~ (shuffle '(a a b b c d d)) nil nil)
    (test-parseq 'peg-expr-and~~ (shuffle '(a a b b c d d)) nil nil)
    ...
    (test-parseq 'peg-expr-and~~ (shuffle '(a b b c d)) nil nil)
    (test-parseq 'peg-expr-and~~ (shuffle '(a b b c d)) nil nil)
    (test-parseq 'peg-expr-and~~ (shuffle '(a b b c d)) nil nil)
    (test-parseq 'peg-expr-and~~ (shuffle '(a b b c d)) nil nil)
    (test-parseq 'peg-expr-and~~ (shuffle '(a b b c d)) nil nil)
    ...
    (test-parseq 'peg-expr-and~~ (shuffle '(a b b c d d d d)) nil nil)
    (test-parseq 'peg-expr-and~~ (shuffle '(a b b c d d d d)) nil nil)
    (test-parseq 'peg-expr-and~~ (shuffle '(a b b c d d d d)) nil nil)
    (test-parseq 'peg-expr-and~~ (shuffle '(a b b c d d d d)) nil nil)
    (test-parseq 'peg-expr-and~~ (shuffle '(a b b c d d d d)) nil nil)
    ...
    ;; (and~~ (* + ?) 'a 'b 'c)
    (test-parseq 'peg-expr-and~~2 (shuffle '(a a a b b b c)) t '((a a a) (b b b) (c)))
    (test-parseq 'peg-expr-and~~2 (shuffle '(a a a b b b c)) t '((a a a) (b b b) (c)))
    (test-parseq 'peg-expr-and~~2 (shuffle '(a a a b b b c)) t '((a a a) (b b b) (c)))
    (test-parseq 'peg-expr-and~~2 (shuffle '(a a a b b b c)) t '((a a a) (b b b) (c)))
    (test-parseq 'peg-expr-and~~2 (shuffle '(a a a b b b c)) t '((a a a) (b b b) (c)))
    ...
    (test-parseq 'peg-expr-and~~2 (shuffle '(b b b c)) t '(() (b b b) (c)))
    (test-parseq 'peg-expr-and~~2 (shuffle '(b b b c)) t '(() (b b b) (c)))
    (test-parseq 'peg-expr-and~~2 (shuffle '(b b b c)) t '(() (b b b) (c)))
    (test-parseq 'peg-expr-and~~2 (shuffle '(b b b c)) t '(() (b b b) (c)))
    (test-parseq 'peg-expr-and~~2 (shuffle '(b b b c)) t '(() (b b b) (c)))
    ...
    (test-parseq 'peg-expr-and~~2 (shuffle '(a b)) t '((a) (b) ()))
    (test-parseq 'peg-expr-and~~2 (shuffle '(a b)) t '((a) (b) ()))
    (test-parseq 'peg-expr-and~~2 (shuffle '(a b)) t '((a) (b) ()))
    (test-parseq 'peg-expr-and~~2 (shuffle '(a b)) t '((a) (b) ()))
    ...
    ;; Test backtracking
    (test-parseq 'peg-expr-and~~-backtrack '(a b a b b a) t '((a a a) (b b b)))
    (test-parseq 'peg-expr-and~~-backtrack '(a b a b) t '((a a) (b b)))))
...
(define-test or-test ()
  (check
    ;; (or 'a 'b 'c)
    (test-parseq 'peg-expr-or '(a) t 'a)
    (test-parseq 'peg-expr-or '(b) t 'b)
    (test-parseq 'peg-expr-or '(c) t 'c)
    (test-parseq 'peg-expr-or '(d) nil nil)))

(parseq:defrule peg-expr-not () (not 'a))
(parseq:defrule peg-expr-not-implicit-or () (not 'a 'b 'c 'd))
...
(define-test not-test ()
  (check
    ...
    ;; Implicit or: (not 'a 'b)
    (test-parseq 'peg-expr-not-implicit-or '() nil nil)
    (test-parseq 'peg-expr-not-implicit-or '(a) nil nil)
    (test-parseq 'peg-expr-not-implicit-or '(b) nil nil)
    (test-parseq 'peg-expr-not-implicit-or '(c) nil nil)
    (test-parseq 'peg-expr-not-implicit-or '(d) nil nil)
...
(define-test *-test ()
  (check
    ;; (* 'a)
    (test-parseq 'peg-expr-* '() t nil)
    (test-parseq 'peg-expr-* '(a) t '(a))
    (test-parseq 'peg-expr-* '(a a) t '(a a))
    (test-parseq 'peg-expr-* '(a a a) t '(a a a))
...
(define-test +-test ()
  (check
    ...
    (test-parseq 'peg-expr-+-implicit-or '(a) t '(a))
    (test-parseq 'peg-expr-+-implicit-or '(b) t '(b))
    (test-parseq 'peg-expr-+-implicit-or '(c) t '(c))
    (test-parseq 'peg-expr-+-implicit-or '(d) t '(d))
    (test-parseq 'peg-expr-+-implicit-or '(e) nil nil)
    (test-parseq 'peg-expr-+-implicit-or '(a a a) t '(a a a))
    (test-parseq 'peg-expr-+-implicit-or '(b b b) t '(b b b))
    (test-parseq 'peg-expr-+-implicit-or '(c c c) t '(c c c))
    (test-parseq 'peg-expr-+-implicit-or '(d d d) t '(d d d))))
...
(define-test &-test ()
  (check
    ...
    ;; (& 'a 'b)
    (test-parseq 'peg-expr-&-implicit-or '(a) t 'a t)
    (test-parseq 'peg-expr-&-implicit-or '(b) t 'b t)
    (test-parseq 'peg-expr-&-implicit-or '(c) nil nil)))
...
(parseq:defrule peg-expr-rep-ab () (rep (3 5) 'a 'b))
(parseq:defrule peg-expr-rep-nil-b () (rep (nil 5) 'a 'b))
(parseq:defrule peg-expr-rep-a-nil () (rep (3 nil) 'a 'b))
(parseq:defrule peg-expr-rep-nil-nil () (rep (nil nil) 'a 'b))
(parseq:defrule peg-expr-rep-* () (rep * 'a 'b))
(parseq:defrule peg-expr-rep-+ () (rep + 'a 'b))
(parseq:defrule peg-expr-rep-? () (rep ? 'a 'b))
...
(define-test rep-test ()
  (check
    ;; (rep 4 'a 'b)
    (test-parseq 'peg-expr-rep '() nil nil)
    (test-parseq 'peg-expr-rep '(a a a) nil nil)
    (test-parseq 'peg-expr-rep '(a a a a) t '(a a a a))
    (test-parseq 'peg-expr-rep '(a b a a) t '(a b a a))
    (test-parseq 'peg-expr-rep '(a c a a) nil nil)
    (test-parseq 'peg-expr-rep '(a a a a a) nil nil)
    ;; (rep (4) 'a 'b)
    (test-parseq 'peg-expr-rep-b '() t '())
    (test-parseq 'peg-expr-rep-b '(a) t '(a))
    (test-parseq 'peg-expr-rep-b '(a a) t '(a a))
    (test-parseq 'peg-expr-rep-b '(a a a) t '(a a a))
    (test-parseq 'peg-expr-rep-b '(a b a) t '(a b a))
    (test-parseq 'peg-expr-rep-b '(a c a) nil nil)
    (test-parseq 'peg-expr-rep-b '(b b b) t '(b b b))
    (test-parseq 'peg-expr-rep-b '(a a a a) t '(a a a a))
    (test-parseq 'peg-expr-rep-b '(a a a a a) nil nil)
    ;; (rep (nil 5) 'a 'b)
    (test-parseq 'peg-expr-rep-nil-b '() t '())
    (test-parseq 'peg-expr-rep-nil-b '(a) t '(a))
    (test-parseq 'peg-expr-rep-nil-b '(a a) t '(a a))
    (test-parseq 'peg-expr-rep-nil-b '(a a a) t '(a a a))
    (test-parseq 'peg-expr-rep-nil-b '(a b a) t '(a b a))
    (test-parseq 'peg-expr-rep-nil-b '(a c a) nil nil)
    (test-parseq 'peg-expr-rep-nil-b '(b b b) t '(b b b))
    (test-parseq 'peg-expr-rep-nil-b '(a a a a) t '(a a a a))
    (test-parseq 'peg-expr-rep-nil-b '(a a a a a) t '(a a a a a))
    (test-parseq 'peg-expr-rep-nil-b '(a a a a a a) nil nil)
    ;; (rep (3 5) 'a 'b)
    (test-parseq 'peg-expr-rep-ab '(a a) nil nil)
    (test-parseq 'peg-expr-rep-ab '(a a a) t '(a a a))
    (test-parseq 'peg-expr-rep-ab '(a a a a) t '(a a a a))
    (test-parseq 'peg-expr-rep-ab '(a b a a) t '(a b a a))
    (test-parseq 'peg-expr-rep-ab '(a c a a) nil nil)
    (test-parseq 'peg-expr-rep-ab '(b b b b) t '(b b b b))
    (test-parseq 'peg-expr-rep-ab '(a a a a a) t '(a a a a a))
    (test-parseq 'peg-expr-rep-ab '(a a a a a a) nil nil)
    ;; (rep (3 nil) 'a 'b)
    (test-parseq 'peg-expr-rep-a-nil '(a) nil nil)
    (test-parseq 'peg-expr-rep-a-nil '(a a) nil nil)
    (test-parseq 'peg-expr-rep-a-nil '(a a a) t '(a a a))
    (test-parseq 'peg-expr-rep-a-nil '(a a a a) t '(a a a a))
    (test-parseq 'peg-expr-rep-a-nil '(a a b a) t '(a a b a))
    (test-parseq 'peg-expr-rep-a-nil '(a a c a) nil nil)
    (test-parseq 'peg-expr-rep-a-nil '(b b b b) t '(b b b b))
    (test-parseq 'peg-expr-rep-a-nil '(a a a a a) t '(a a a a a))
    (test-parseq 'peg-expr-rep-a-nil '(a a a a a a) t '(a a a a a a))
    ;; (rep (nil nil) 'a 'b)
    (test-parseq 'peg-expr-rep-nil-nil '() t '())
    (test-parseq 'peg-expr-rep-nil-nil '(a) t '(a))
    (test-parseq 'peg-expr-rep-nil-nil '(a a) t '(a a))
    (test-parseq 'peg-expr-rep-nil-nil '(a a a) t '(a a a))
    (test-parseq 'peg-expr-rep-nil-nil '(a a a a) t '(a a a a))
    (test-parseq 'peg-expr-rep-nil-nil '(b a a a) t '(b a a a))
    (test-parseq 'peg-expr-rep-nil-nil '(c a a a) nil nil)
    (test-parseq 'peg-expr-rep-nil-nil '(b b b b) t '(b b b b))
    (test-parseq 'peg-expr-rep-nil-nil '(a a a a a) t '(a a a a a))
    (test-parseq 'peg-expr-rep-nil-nil '(a a a a a a) t '(a a a a a a))
    ;; (rep * 'a 'b)
    (test-parseq 'peg-expr-rep-* '() t '())
    (test-parseq 'peg-expr-rep-* '(a) t '(a))
    (test-parseq 'peg-expr-rep-* '(a a) t '(a a))
    (test-parseq 'peg-expr-rep-* '(a a a) t '(a a a))
    (test-parseq 'peg-expr-rep-* '(a a b) t '(a a b))
    (test-parseq 'peg-expr-rep-* '(a a c) nil nil)
    (test-parseq 'peg-expr-rep-* '(b b b) t '(b b b))
    (test-parseq 'peg-expr-rep-* '(a a a a) t '(a a a a))
    ;; (rep + 'a 'b)
    (test-parseq 'peg-expr-rep-+ '() nil nil)
    (test-parseq 'peg-expr-rep-+ '(a) t '(a))
    (test-parseq 'peg-expr-rep-+ '(a a) t '(a a))
    (test-parseq 'peg-expr-rep-+ '(a a a) t '(a a a))
    (test-parseq 'peg-expr-rep-+ '(a b a) t '(a b a))
    (test-parseq 'peg-expr-rep-+ '(a c a) nil nil)
    (test-parseq 'peg-expr-rep-+ '(b b b) t '(b b b))
    (test-parseq 'peg-expr-rep-+ '(a a a a) t '(a a a a))
    ;; (rep ? 'a 'b)
    (test-parseq 'peg-expr-rep-? '() t '())
    (test-parseq 'peg-expr-rep-? '(a) t '(a))
    (test-parseq 'peg-expr-rep-? '(b) t '(b))
    (test-parseq 'peg-expr-rep-? '(c) nil nil)
...
(define-test list-test ()
  (check
    ;; (list 'a)
    (test-parseq 'peg-expr-list '() nil nil)
    (test-parseq 'peg-expr-list '(a) nil nil)
    (test-parseq 'peg-expr-list '((a)) nil nil)
    (test-parseq 'peg-expr-list '((a b)) t '(a b))
...
(define-test string-test ()
  (check
    ;; (string #\a)
    (test-parseq 'peg-expr-string '("") nil nil)
    (test-parseq 'peg-expr-string '("a") nil nil)
    (test-parseq 'peg-expr-string '("b") nil nil)
    (test-parseq 'peg-expr-string '("aa") nil nil)
    (test-parseq 'peg-expr-string '("ab") t '(#\a #\b))
    (test-parseq 'peg-expr-string '("bb") nil nil)
    (test-parseq 'peg-expr-string '((#\a #\b)) nil nil)))
...
(define-test vector-test ()
  (check
    ;; (vector 4)
    (test-parseq 'peg-expr-vector '(#()) nil nil)
    (test-parseq 'peg-expr-vector '(#(3)) nil nil)
    (test-parseq 'peg-expr-vector '(#(4)) nil nil)
    (test-parseq 'peg-expr-vector '(#(4 4)) nil nil)
    (test-parseq 'peg-expr-vector '(#(4 5)) t '(4 5))
    (test-parseq 'peg-expr-vector '(#(5 5)) nil nil)
    (test-parseq 'peg-expr-vector '((4)) nil nil)))
...
(parseq:defrule runtime-dispatch-character-set-not () (in-brackets (char "^a-z")))
...
(define-test runtime-dispatch-test ()
  (check
    ...
    (test-parseq 'runtime-dispatch-character-set-not "(A)" t '("(" #\A ")"))
    (test-parseq 'runtime-dispatch-character-set-not "(a)" nil nil)
    (test-parseq 'runtime-dispatch-character-set-not "(z)" nil nil)
...
(parseq:defrule option-choose-one () (and 'a (* 'b) (rep 1 'c) (? (and (+ 'd) 'e)) 'f) (:choose 1))
(parseq:defrule option-choose-many () (and 'a (* 'b) (rep 1 'c) (? (and (+ 'd) 'e)) 'f) (:choose 0 0 '(1 5) 2 '(3 1) '(3 0 0) -1 -10))
...
(define-test option-test ()
  (check
    ...
    ;; (and 'a (* 'b) (rep 1 'c) (? (and (+ 'd) 'e)) 'f) (:choose 1)
    (test-parseq 'option-choose-one '(a b c d e f) t '(b))
    (test-parseq 'option-choose-one '(a b b b c d e f) t '(b b b))
    ;; (and 'a (* 'b) (rep 1 'c) (? (and (+ 'd) 'e)) 'f) (:choose 0 0 '(1 5) 2 '(3 1) '(3 0 0) -1 -10)
    (test-parseq 'option-choose-many '(a b c d e f) t '(a a nil (c) e d f nil))
    (test-parseq 'option-choose-many '(a b b b b b b b c d e f) t '(a a b (c) e d f nil))
    (test-parseq 'option-choose-many '(a c d e f) t '(a a nil (c) e d f nil))
    (test-parseq 'option-choose-many '(a b c f) t '(a a nil (c) nil nil f nil))
...
(define-test namespace-test ()
  (check-with-side-effects
    ...
    (parseq:with-local-rules
      (condition= (parseq:parseq 'peg-expr-and '(a b c)) parseq:unknown-rule-error))
    (parseq:with-local-rules
      (parseq:defrule peg-expr-and () (and 'd 'e 'f))
      (test-parseq 'peg-expr-and '(a b c) nil nil))
    (parseq:with-local-rules
      (parseq:defrule peg-expr-and () (and 'd 'e 'f))
      (test-parseq 'peg-expr-and '(d e f) t '(d e f)))
    ;; Saved rules
    ...
    ;; Sanity check
    (test-parseq 'peg-expr-and '(a b c) t '(a b c))
    (test-parseq 'peg-expr-and '(d e f) nil nil)))
