...
(defrule option-choose () (and 'a (* 'b) 'c (? (and (+ 'd) 'e)) 'f) (:choose 0 0 '(1 5) 2 '(3 1) '(3 0 0)))
...
(define-test option-test ()
  (check
    ...
    ;; (and 'a (* 'b) 'c (? (and (+ 'd) 'e)) 'f) (:choose 0 0 '(1 5) 2 '(3 1) '(3 0 0))
    (test-parseq 'option-choose '(a b c d e f) t '(a a nil c e d))
    (test-parseq 'option-choose '(a b b b b b b b c d e f) t '(a a b c e d))
    (test-parseq 'option-choose '(a c d e f) t '(a a nil c e d))
    (test-parseq 'option-choose '(a b c f) t '(a a nil c nil nil))
