...
(defrule option-choose () (and 'a 'b 'c (? (and 'd 'e)) 'f) (:choose 0 2 '(3 1)))
...
(define-test option-test ()
  (check
    ...
    ;; (and 'a 'b 'c (? (and 'd 'e)) 'f) (:choose 0 2 '(3 1)))
    (test-parseq 'option-choose '(a b c d e f) t '(a c e))
    (test-parseq 'option-choose '(a b c f) t '(a c nil))
